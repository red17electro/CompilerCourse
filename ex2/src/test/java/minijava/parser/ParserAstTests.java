...
public class ParserAstTests {
	...
	public void testWithoutParameters() throws Exception {
		String input = "class Main{ public static void main(String[] a){}} class A{ int m(){return 0;}}";
		MJProgram ast = new MJFrontend().parseString(input);
		String printed = AstPrinter.print(ast);
		Assert.assertThat(printed, CoreMatchers.containsString("int m()"));
	}
	...
	@Test
	public void testPrintMethodCallWithParams() throws Exception {
		String input = "class Main { public static void main(String[] args) { System.out.println(a.z(k)); }}";
		MJProgram ast = new MJFrontend().parseString(input);
		String printed = AstPrinter.print(ast);
		Assert.assertThat(printed, CoreMatchers.containsString("System.out.println(a.z(k));"));
	}
}
