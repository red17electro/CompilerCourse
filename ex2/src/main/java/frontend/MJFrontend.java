...
// in miniJava having two dimensions array  is forbidden , we are preventing this case here
     ...
     *
     * @param value parsed MJProgram object
     */
    private void detectInvalidStatements(MJProgram value) {
        InvalidStatementsChecker v = new InvalidStatementsChecker(syntaxErrors);
        value.accept(v);
    }
